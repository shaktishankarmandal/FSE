...
namespace api.Controller
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("signin")]
        public async Task<ActionResult<UserDetails>> AuthenticateUserAsync(SignInRequest request)
        {
        ...
        [HttpPost]
        [Route("resetPassword")]
        public async Task<ActionResult<UserDetails>> ResetPasswordAsync(ResetPasswordRequest request)
        {
